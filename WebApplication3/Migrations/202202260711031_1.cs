                ...
                c => new
                    {
                        ...
                        WeaponName = c.String(),
                        WeaponCreationYear = c.Int(nullable: false),
                        WeaponDescription = c.String(),
                        CollectionsID = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.WeaponID)
                .ForeignKey("dbo.Collections", t => t.CollectionsID, cascadeDelete: true)
                .Index(t => t.CollectionsID);
            
        }
        
        public override void Down()
        {
            DropForeignKey("dbo.Weapons", "CollectionsID", "dbo.Collections");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.Weapons", new[] { "CollectionsID" });
